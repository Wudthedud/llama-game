        ...
        while not self.quit_game:
            ...
            if self.show_start:
                ...
                if self.spawn_timer >= self.spawn_interval:
                    ...
                    if self.spawn_interval > self.min_spawn_interval:
                        self.spawn_interval = random.randint(self.min_spawn_interval, self.spawn_interval)
                ...
                if self.spawn_interval > 0:
                    obs_per_sec = 60 / self.spawn_interval
                else:
                    obs_per_sec = 0
                spd_text = self.tiny_font.render(f"Obstacles/sec: {obs_per_sec:.2f}", True, white)
